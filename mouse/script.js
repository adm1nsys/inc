...
$(document).ready(function() {
  ...
  function updateStartColor() {
      ...
      document.getElementById("modeStart").style.backgroundColor = startColor;
      document.getElementById("colorBox4").style.backgroundColor = startColor;
  }
updateStartColor()
  function updateTargetColor() {
      ...
      document.getElementById("modeTarget").style.backgroundColor = targetColor;
      document.getElementById("colorBox3").style.backgroundColor = targetColor;
  }
updateTargetColor()
      ...
      $('.divForGame').each(function() {
          ...
          ['top', 'bottom', 'left', 'right'].forEach(border => {
              if (!cell.data('border-' + border)) {
                  cell.css('border-' + border, `2px solid ${cellColor}`);
              }
          });
      });
      document.getElementById("colorBox1").style.backgroundColor = cellColor;
      ...
      $('.divForGame').each(function() {
          ...
          ['top', 'bottom', 'left', 'right'].forEach(border => {
              if (cell.data('border-' + border) === 'toggled') {
                  cell.css('border-' + border, `2px solid ${borderColor}`);
              }
          });
      });
      document.getElementById("modePaint").style.backgroundColor = borderColor;
      document.getElementById("colorBox2").style.backgroundColor = borderColor;
...
updateBorderColor()
  ...
  function toggleBorder(cell, row, col, border) {
    ...
    var newStyle = currentState === 'toggled' ? `2px solid ${cellColor}` : `2px solid ${borderColor}`;
    ...
    if (adjCell.length) {
      ...
      var adjNewStyle = adjCurrentState === 'toggled' ? `2px solid ${cellColor}` : `2px solid ${borderColor}`;
